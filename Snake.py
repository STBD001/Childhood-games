...
def game_over():
    canvas.delete(ALL)
    canvas.create_text(canvas.winfo_width()/2, canvas.winfo_height()/2 - 30, font=('consolas', 70), text="GAME OVER", fill="red", tag="gameover")
...
def start_game():
    global snake, food, obstacles, paused, direction, score, canvas, label, window, setup_frame
    ...
    start_button = Button(setup_frame, text="Start Game", command=begin_game)
...
def begin_game():
    global setup_frame, snake, food, obstacles
